...
import InterlockSubModelSchema from './interlockSubSchema.js';

const InterlockSchema = new mongoose.Schema({
    ...
    subModels: { type: [InterlockSubModelSchema], default: [] }
});

const InterlockModel = mongoose.model('Interlock', InterlockSchema);
export default InterlockModel;
